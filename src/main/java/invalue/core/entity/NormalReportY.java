...
public class NormalReportY implements java.io.Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "normal_report_y_generator")
	@SequenceGenerator(name="normal_report_y_generator", sequenceName = "normal_report_y_seq", allocationSize=1)
