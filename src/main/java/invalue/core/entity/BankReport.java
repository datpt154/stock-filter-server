...
@Entity
@Table(name = "bank_report", uniqueConstraints = {@UniqueConstraint(columnNames = "CODE") })
public class BankReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bank_report_generator")
	@SequenceGenerator(name="bank_report_generator", sequenceName = "bank_report_seq", allocationSize=1)
