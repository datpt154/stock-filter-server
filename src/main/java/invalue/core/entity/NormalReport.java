...
@Entity
@Table(name = "normal_report", uniqueConstraints = {@UniqueConstraint(columnNames = "CODE") })
public class NormalReport implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "normal_report_generator")
	@SequenceGenerator(name="normal_report_generator", sequenceName = "normal_report_seq", allocationSize=1)
