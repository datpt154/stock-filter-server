...
public class Unicode2English {
	...
	static volatile HashMap<String, String> codauTokhongdau = null;

	/** The codau toncr decimal. */
	static volatile HashMap<String, String> codauToncrDecimal = null;

	/** The codau to ut f8 literal. */
	static volatile HashMap<String, String> codauToUTF8Literal = null;
	...
	public static String removeDauNoTrim(String input) {
		if (StringUtil.isNullOrEmpty(input))
			return "";
//		input = input.trim();
		for (int i = 0; i < MAX_CO_DAU.length; i++) {
	...
	public static String removeDauNoSpace(String input) {
		if (StringUtil.isNullOrEmpty(input))
			return "";
		for (int i = 0; i < MAX_CO_DAU.length; i++) {
			input = input.replace(MAX_CO_DAU[i], MAX_KHONG_DAU[i]);
